...
- Node.js 18+ 
- npm or yarn
- Contentful account (optional - app works with pre-configured credentials)
- Anima account (optional - for generating new components)
...
4. **Optional: Set up your own Contentful (for customization)**
   
   Create a `.env` file in the root directory:
   ```bash
   # Contentful Configuration (optional - app works without these)
...
5. **Optional: Populate your own Contentful**
   ```bash
   npm run populate
   ```
